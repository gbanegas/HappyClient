# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in happy.
...
from happy.lib import app_globals, helpers 
...
base_config.model = happy.model
base_config.DBSession = happy.model.DBSession
# Configure the authentication backend

# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP 
base_config.sa_auth.cookie_secret = "878bf013-1ade-41ff-8398-6037e2077d77"
